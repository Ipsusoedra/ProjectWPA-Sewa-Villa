  ...
  <div class="container-spec d-flex align-content-between flex-wrap mt-3 mb-3 data-spec" id="data-spec">
    <div class="spec-item flex-column flex-fill justify-content-column m-0 mt3 p-3 radius-16">
      ...
      <div class="d-flex justify-content-between mt-3">
        <button class="bg-warning text-white" style="padding: 12px 20px; border-radius: 8px; border: none" onclick="editUser(<?php echo $_SESSION['user_id']; ?>);">Edit</button>
    ...
    <div class="modal-content">
      <form id="form-barang">
        ...
        <div class="modal-footer">
          ...
          <button style="font-size: 12px; font-weight: normal" type="submit" id="btnSubmit" class="btn btn-warning text-white" onclick="simpanAkun();">Simpan</button>
        </div>
      </form>
    </div>
  </div>
